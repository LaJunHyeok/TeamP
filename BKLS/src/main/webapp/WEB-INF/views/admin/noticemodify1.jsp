		...
		<div class="row justify-content-center">
			...
			<input type="hidden" name=" num" value="${dto.notice_num}"> 
					...
					<div class="form-group row">
						<label for="notice_num" class="col-sm-2 col-form-label">번호</label>
						<div class="col-sm-10">${dto.notice_num}</div>
					</div>
					
					 
					<div class="form group row">
						<label for="notice_hit" class="col-sm-2 col-form-label">조회수</label>
						<div class="col-sm-10">${dto.notice_hit}</div>
					
					</div>
					<div class="form group row">
						<label for="notice_id" class="col-sm-2 col-form-label">아이디</label>
					...
					<div class="form-group row">
						<label for="notice_content" class="col-sm-2 col-form-label">내용</label>
						<div class="col-sm-10">
							<textarea id="editor1" rows="10" name="notice_content"
								class="form-control" value=>${dto.notice_content}</textarea>
							<script>
